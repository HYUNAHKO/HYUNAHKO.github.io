...
const octahedron = new RegularOctahedron(gl); // Changed to use internal vertex data
...
async function main() {
    try {
        ...
        console.log('Shader uniform u_texture set to unit 0');
        shader.setVec3('u_lightDir', [1.0, 1.0, 1.0]);
